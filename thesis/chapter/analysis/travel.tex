...
\begin{description}
    ...
    Since the country codes and names used by the \ac{iana} database and Natural Earth don't always match, another layer with more information about country names and country codes was necessary.
