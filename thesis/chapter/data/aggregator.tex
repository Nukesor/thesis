...
A model for commits, emails, repositories, contributers and organizations has been created.
...
\begin{description}
    \item[Git repository]\label{stand-alone-repository-scan} \hfill \\
        ...
        Thereby we cannot easily link several email addresses to a specific contributer without additional metadata.
    ...
    \item[Github Repository]\label{github-repo-scan} \hfill \\
        ...
        However, a request to Github is issued every time an email is found, which we do not already have linked to a contributer.
