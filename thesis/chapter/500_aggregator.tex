...
Without this mechanism it could be possible that the same commit of a contributer could be analyzed multiple times as a result of repository forking.
...
Looking at the collected data it appears that roughly every fifth email address scraped from Github is no longer connected to an active user.
